package cardosofgui.android.pokedexcompose.feature.pokemons.ui.favorites
...
@Composable
internal fun PokemonsActivity.FavoritesPokemonList(
    ...
    val pokemonList =
        remember(
            ...
            state.filterFavoritePokemonList
        ) {
            if(state.hasFilterPokemon) state.filterFavoritePokemonList
            else state.favoritePokemonList
        }
    ...
    AnimatedVisibility(
        ...
        Column {
            Row(
                ...
                Text(
                    text = "${pokemonList.size} Pokémon Favoritos",
